...
API.prototype.endCandleGenerate = require("./websocket/endcandlegenerate")
API.prototype.getAssets = require("./websocket/getassets")
API.prototype.getActiveInfo = require("./websocket/getactiveinfo")
API.prototype.getActiveList = require("./websocket/getactivelist")
API.prototype.getInstruments = require("./websocket/getinstruments")
API.prototype.suscribeOption = require("./websocket/suscribeOption")
API.prototype.unSuscribeOption = require("./websocket/unSuscribeOption")
